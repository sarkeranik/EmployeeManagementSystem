namespace EmployeeManagement.Databases;

using EmployeeManagement.Domain;
using EmployeeManagement.Databases.EntityConfigurations;
...
public sealed class EmployeesDbContext : DbContext
{
    ...
    public EmployeesDbContext(
        DbContextOptions<EmployeesDbContext> options, ICurrentUserService currentUserService, IMediator mediator, IDateTimeProvider dateTimeProvider) : base(options)
    {
