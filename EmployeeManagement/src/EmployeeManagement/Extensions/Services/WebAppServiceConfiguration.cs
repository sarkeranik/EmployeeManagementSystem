...
public static class WebAppServiceConfiguration
{
    public static void ConfigureServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddCorsService("EmployeeManagementCorsPolicy", builder.Environment);
        builder.OpenTelemetryRegistration("EmployeeManagement");
        ...
        // registers all services that inherit from your base service interface - IEmployeeManagementService
    ...
    private static void AddBoundaryServices(this IServiceCollection services, params Assembly[] assemblies)
    {
        ...
        foreach (var assembly in assemblies)
        {
            var rules = assembly.GetTypes()
                .Where(x => !x.IsAbstract && x.IsClass && x.GetInterface(nameof(IEmployeeManagementService)) == typeof(IEmployeeManagementService));
